...
public class RegisterController {
	...
	public String registerValid(Model model, @Valid @ModelAttribute("custo") @RequestBody customer custo, Errors errors)
			throws MessagingException {
				String username = paramService.getString("name", "");
		...
		if (!confirm.equals(password)) {
			...
			mailer.send(email, "Account Register", "Username: " + username + " Password: " + password);
